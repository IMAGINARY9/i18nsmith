...
export class ReactWriter {
    ...
    async prepare(candidate, project) {
    ...
    async transform(candidate, project) {
        if (!project) {
        ...
        const didMutate = this.applyCandidate(candidate);
    ...
    normalizeTranslationSnippet(snippet) {
...
//# sourceMappingURL=ReactWriter.js.map