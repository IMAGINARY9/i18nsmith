import type { KeyGenerator, LocaleDiffEntry, LocaleFileStats, LocaleStore, ScanCandidate, SourceFileDiffEntry } from '@i18nsmith/core';
export type CandidateStatus = 'pending' | 'duplicate' | 'existing' | 'applied' | 'skipped';
